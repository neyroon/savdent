...
export const FormPopup = ({ isModalOpen, onClose }) => {
  ...
  const renderContent = () => (
    <>
      {!isSuccess ? (
        <div className=" md:py-[40px] px-[20px] xl:px-[40px] bg-white w-full rounded-[30px] flex flex-col md:flex-row-reverse gap-[50px]">
          <img
            src={zapicImg}
            alt="Фотография"
